    ...
    return (
        <div className="bg-gray-800 p-6 rounded-lg">
            <div className="flex justify-between items-center mb-4">
                <h3 className="text-lg font-bold text-white">Entidades Afiliadas</h3>
                    ...
                    <div key={entity.id} className="bg-gray-700 p-4 rounded-lg">
                        <div className="flex justify-between items-start">
                            ...
                            <div className="flex items-center space-x-3">
                                ...
                                <button onClick={() => handleEdit(entity)} onMouseDown={handleMouseDown} className="text-sm text-indigo-400 hover:text-indigo-300 ripple-effect">Editar</button>
                                <button onClick={() => handleDelete(entity.id)} onMouseDown={handleMouseDown} className="text-sm text-red-400 hover:text-red-300 ripple-effect">Eliminar</button>
                            </div>
                        </div>
