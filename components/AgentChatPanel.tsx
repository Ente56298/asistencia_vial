...
import { AssistanceType, Content } from '../types';
                ...
                <footer className="p-4 border-t border-gray-700 bg-gray-900/50">
                    <form onSubmit={handleSend} className="flex gap-2">
                        <input 
                            ...
                            disabled={isLoading}
                        />
                        <button type="submit" onMouseDown={handleMouseDown} className="bg-cyan-500 text-white font-bold py-2 px-4 rounded-md hover:bg-cyan-400 disabled:bg-cyan-800 ripple-effect" disabled={isLoading || !userInput.trim()}>
                            Enviar
                        </button>
                    </form>
                </footer>
